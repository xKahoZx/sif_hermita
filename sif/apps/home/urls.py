...
<<<<<<< HEAD
	url(r'^entradas/(?P<id_sede>.*)/$', 'entrada_view_sede' , name = 'vista_entrada_sede'),
=======
>>>>>>> 8bf3e0241d0b5598f8167dfcfdabe3bfe8c4feba
	#Usuario
...
<<<<<<< HEAD
	url(r'^salidas/(?P<id_sede>.*)/$', 'salida_view_sede' , name = 'vista_salida_sede'),
	#Proveedor
	...
	url(r'^productos/(?P<id_sede>.*)/$', 'producto_view_sede' , name = 'vista_producto_sede'),
=======
	#Proveedor
